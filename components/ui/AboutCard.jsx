...
function AboutCard({ detailsCard, children, className }) {
  ...
  return (
    <div
      className={`absolute w-[80%] h-[450px] md:w-[350px] md:h-[500px] md:-skew-x-12 flex flex-col items-start justify-start p-4 bg-black/[60%] border border-white-[1%] ${transformClass} ${className}`}
    >
      <CardCorners />
