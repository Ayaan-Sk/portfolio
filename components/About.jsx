...
function About() {
  return (
    <div
      id="about"
      className="about relative flex flex-col w-screen h-[60vh] px-4 md:flex-row md:px-[50px] lg:px-[200px] lg:pr-[100px] pointer-events-none"
    >
      <div
      ...
      >
        ...
        <h1 className="text-4xl mb-3 font-medium md:text-6xl lg:text-7xl md:mt-[30px] md:text-nowrap">
          Chrys {"{ca.io}"}
        </h1>
